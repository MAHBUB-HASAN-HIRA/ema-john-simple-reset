    ...
    return (
        <div className='header'>
            ...
            <nav>
                ...
                {
                    (loggedInUser.displayName || loggedInUser.name) && <span className='link_item' to="/inventory">Welcome <strong>{loggedInUser.displayName || loggedInUser.name}</strong></span>
                }
